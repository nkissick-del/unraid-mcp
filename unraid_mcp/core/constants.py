...
# Array admin operation retry config
ARRAY_ADMIN_OPERATION_SETTLE_DELAY_S = 3.0
ARRAY_ADMIN_STATE_MAX_RETRIES = 5
ARRAY_ADMIN_STATE_INITIAL_DELAY_S = 2.0
ARRAY_ADMIN_STATE_BACKOFF_FACTOR = 1.5
